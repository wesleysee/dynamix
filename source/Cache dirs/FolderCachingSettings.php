...
<?=mk_option($ini['shares'], "-u", "Yes")?>
  ...
  <td><input type="text" name="other" maxlength="200" value="<?=$ini['other']?>">see <a href="http://lime-technology.com/forum/index.php?topic=4500.0" target="_blank">unRAID forum</a></td>
  </tr>
  <tr>
...
<div style="position:fixed;bottom:36px;font-style:italic"><?=exec("$fName -V")?></div>