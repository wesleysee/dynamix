...
<div style="position:fixed;bottom:36px;font-style:italic;font-size:x-small"><?=exec("$fName -v|awk '/^lighttpd/ {print $1}'|sed 's/\// version: /'")?> &bullet; <?=exec(" php -v|awk '/^PHP/ {print $1,\"version:\",$2}'")?></div>