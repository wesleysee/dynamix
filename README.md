...
*DO NOT DOWNLOAD FILES DIRECTLY FROM THE FOLDER 'DOWNLOAD' OR 'PLUGINS' BUT USE THE LINKS PROVIDED IN THIS 'README' FILE INSTEAD. THE SAME IS TRUE FOR THE OPTIONAL PLUGINS - USE THE LINKS PROVIDED IN THE FILE 'OPTIONAL PLUGINS.MD'*
